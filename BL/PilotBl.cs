...
namespace MetuljmaniaDatabase.Bl
{
    public class PilotBl : BaseBl, IPilotBl
    {
        ...
        private async Task NotifyPilot(PilotBlModel pilot, string filepath)
        {
            ...
            var body = $"<h1>Hi, {pilot.FirstName} {pilot.LastName}!</h1><p>You registered for paragliding cross country competition <strong>{pilot.Event.Name}</strong> and a few seconds ago you have requested the official application form. Attached we are sending you the automatically generated application form (PDF).</p><h5>Ps.:</h5><p>It is <strong>NOT</strong> obligatory, but if you wish you can sign the PDF and upload it back to our database <strong><a href=\"https://register-metulj.web.app/upload\" >following this link</a></strong>.</p><p>Thank you!</p>";
